...
class ScoreEncodingApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __assessment_email(
            self,
            cohort_name,
            **kwargs
        ):
            """assessment_email  # noqa: E501

            Return the email of score encoding on a specified cohort  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.assessment_email(cohort_name, async_req=True)
            >>> result = thread.get()
        ...
        self.assessment_email = _Endpoint(
            settings={
                'response_type': (AssessmentMail,),
                'auth': [
                    'Token'
                ],
                'endpoint_path': '/{cohort_name}/email',
                'operation_id': 'assessment_email',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        def __get_next_session(
            self,
            **kwargs
        ):
            """get_next_session  # noqa: E501

            Return next session exam  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_next_session(async_req=True)
            >>> result = thread.get()
        ...
        self.get_next_session = _Endpoint(
            settings={
                'response_type': (SessionExam,),
                'auth': [
                    'Token'
        ...
        def __get_overview(
            ...
            **kwargs
            ...
            Return score encoding progress overview for a tutor  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        self.get_overview = _Endpoint(
            settings={
                'response_type': (ProgressOverview,),
                'auth': [
                    'Token'
                ],
        ...
        def __get_previous_session(
            self,
            **kwargs
        ):
            """get_previous_session  # noqa: E501

            Return previous session exam  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_previous_session(async_req=True)
            >>> result = thread.get()
        ...
        self.get_previous_session = _Endpoint(
            settings={
                'response_type': (SessionExam,),
                'auth': [
                    'Token'
            ...
            api_client=api_client,
            callable=__get_previous_session
        )
